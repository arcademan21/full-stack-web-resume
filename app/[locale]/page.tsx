...
import { Github, Linkedin, Mail, FileDown, FileText, LayoutTemplate, Server, Bot, Database, Cloud, History, Quote, Code, Code2, Menu, User, Briefcase, GraduationCap, Languages } from "lucide-react"
...
Email: haroldyarturo@gmail.com | LinkedIn: linkedin.com/in/haroldyarturo | GitHub: github.com/ARCADEMAN21
...
... (View full web version for details)
...
`
    ...
    a.href = url
    a.download = "cv-senior-fullstack-developer.txt"
    ...
    <div className="relative min-h-screen bg-background">
      ...
      <div className="relative z-10">
            ...
            <div className="flex h-16 items-center justify-between">
              ...
              <div className="flex md:hidden items-center">
                 <Sheet open={isMobileMenuOpen} onOpenChange={setIsMobileMenuOpen}>
                  ...
                  <SheetContent side="left" hideClose className="border-r border-border/40 w-[85vw] sm:w-[350px] bg-background">
          ...
          <div className="max-w-7xl">
            ...
            <div className="flex flex-wrap items-center gap-4 mb-12">
              <Button variant="outline" size="lg" asChild>
                <a href="https://github.com/ARCADEMAN21" target="_blank" rel="noopener noreferrer" className="gap-2">
                  <Github className="h-5 w-5" />
                  GitHub
                </a>
              </Button>
              <Button variant="outline" size="lg" asChild>
                <a href="https://www.linkedin.com/in/haroldyarturo/" target="_blank" rel="noopener noreferrer" className="gap-2">
            ...
            <Card className="p-6 bg-accent/50 border-accent max-w-2xl">
              <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                  <h3 className="text-lg font-semibold mb-1">{t('Hero.downloadCV')}</h3>
                  <p className="text-sm text-muted-foreground">{t('Hero.downloadFormat')}</p>
                </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-end">
              ...
              <div className="relative flex justify-center md:justify-start">
                <div className="relative w-full max-w-2xl aspect-square overflow-hidden">
                   <img 
                      src="/dev-profile-without-bg.png" 
        ...
        <section id="skills" className="container mx-auto px-4 sm:px-6 lg:px-8 py-16">
          <div className="max-w-7xl">
            <h2 className="text-3xl sm:text-4xl font-bold mb-12">{t('Skills.title')}</h2>
            ...
            <div className="grid gap-8 sm:grid-cols-2 lg:grid-cols-3">
              ...
              <Card className="p-6 hover:border-foreground/20 transition-colors">
                <div className="flex items-center justify-between mb-4">
                  ...
                  <Badge variant="secondary" className="text-xs bg-blue-500/10 text-blue-700 dark:bg-blue-500/20 dark:text-blue-200 hover:bg-blue-500/20 dark:hover:bg-blue-500/30 border-blue-500/30 border">{t('Skills.specialty')}</Badge>
                </div>
                <div className="flex flex-wrap gap-2">
              ...
              <Card className="p-6 hover:border-foreground/20 transition-colors">
                <div className="flex items-center justify-between mb-4">
                  <div className="flex items-center gap-3">
                    ...
                    <h3 className="text-xl font-semibold">{t('Skills.ai_automation')}</h3>
                  </div>
                  <Badge variant="secondary" className="text-xs bg-blue-500/10 text-blue-700 dark:bg-blue-500/20 dark:text-blue-200 hover:bg-blue-500/20 dark:hover:bg-blue-500/30 border-blue-500/30 border">{t('Skills.highlight')}</Badge>
                </div>
                <div className="flex flex-wrap gap-2">
                  <Badge variant="secondary">{t('Skills.badges.ai_prompting')}</Badge>
                  <Badge variant="secondary">{t('Skills.badges.mcp_protocol')}</Badge>
                  <Badge variant="secondary">{t('Skills.badges.n8n_automation')}</Badge>
                  <Badge variant="secondary">{t('Skills.badges.chatgpt_api')}</Badge>
                  <Badge variant="secondary">{t('Skills.badges.ai_assisted')}</Badge>
                </div>
              </Card>
              ...
              <Card className="p-6 hover:border-foreground/20 transition-colors">
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <h3 className="text-xl font-semibold">{t('Skills.infrastructure')}</h3>
                </div>
                <div className="flex flex-wrap gap-2">
              ...
              <Card className="p-6 hover:border-foreground/20 transition-colors">
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <h3 className="text-xl font-semibold">{t('Skills.legacy_stack')}</h3>
                </div>
                <div className="flex flex-wrap gap-2">
        ...
        <section id="experience" className="container mx-auto px-4 sm:px-6 lg:px-8 py-16">
          <div className="max-w-7xl">
            <h2 className="text-3xl sm:text-4xl font-bold mb-12">{t('Experience.title')}</h2>
            ...
            <div className="space-y-12 max-w-5xl">
              ...
              <div className="relative pl-8 border-l-2 border-primary/30">
                ...
                <div className="mb-4">
                  <div className="flex flex-col sm:flex-row sm:items-baseline sm:justify-between gap-2 mb-2">
                    <h3 className="text-2xl font-semibold">{t('Experience.jobs.adsdigital.role')}</h3>
                    <span className="text-sm text-muted-foreground">2018 - {t('Experience.present')}</span>
                  </div>
                  <p className="text-primary font-medium">{t('Experience.jobs.adsdigital.company')}</p>
                </div>
                ...
                <ul className="space-y-3 text-muted-foreground">
                  <li className="flex gap-3">
                    ...
                    <span>
                      {t.rich('Experience.jobs.adsdigital.desc1', { strong: (chunks) => <strong className="text-foreground font-bold">{chunks}</strong> })}
                    </span>
                  </li>
                  <li className="flex gap-3">
                    <span className="text-primary mt-1.5">•</span>
                    <span>
                      {t.rich('Experience.jobs.adsdigital.desc2', { 
                        strong: (chunks) => <strong className="text-foreground font-bold">{chunks}</strong>,
                        link: (chunks) => <a href="https://www.editor-cv.com/" target="_blank" rel="noopener noreferrer" className="text-primary hover:underline font-bold">{chunks}</a>
                      })}
                    </span>
                  </li>
                  <li className="flex gap-3">
                    ...
                    <span>
                      {t.rich('Experience.jobs.adsdigital.desc3', { 
                        strong: (chunks) => <strong className="text-foreground font-bold">{chunks}</strong>,
                        link: (chunks) => <a href="https://www.find-persons.com/" target="_blank" rel="noopener noreferrer" className="text-primary hover:underline font-bold">{chunks}</a>
                      })}
                    </span>
                  </li>
                  <li className="flex gap-3">
                    ...
                    <span>
                      {t.rich('Experience.jobs.adsdigital.desc4', { 
                        strong: (chunks) => <strong className="text-foreground font-bold">{chunks}</strong>,
                        link: (chunks) => <a href="https://www.allremovebg.com/" target="_blank" rel="noopener noreferrer" className="text-primary hover:underline font-bold">{chunks}</a>,
                        link2: (chunks) => <a href="https://iq-testonline.com/" target="_blank" rel="noopener noreferrer" className="text-primary hover:underline font-bold">{chunks}</a>
                      })}
                    </span>
                  </li>
                </ul>
              ...
              <div className="relative pl-8 border-l-2 border-border">
                ...
                <div className="mb-4">
                  <div className="flex flex-col sm:flex-row sm:items-baseline sm:justify-between gap-2 mb-2">
                    <h3 className="text-2xl font-semibold">{t('Experience.jobs.nwc10.role')}</h3>
                    <span className="text-sm text-muted-foreground">2015 - 2016</span>
                  </div>
                  <p className="text-primary font-medium">{t('Experience.jobs.nwc10.company')}</p>
                </div>
                ...
                <ul className="space-y-3 text-muted-foreground">
                  <li className="flex gap-3">
                    <span className="text-primary mt-1.5">•</span>
                    <span>
                      {t.rich('Experience.jobs.nwc10.desc1', { strong: (chunks) => <strong className="text-foreground font-bold">{chunks}</strong> })}
                    </span>
                  </li>
                  <li className="flex gap-3">
                    <span className="text-primary mt-1.5">•</span>
                    <span>
                      {t.rich('Experience.jobs.nwc10.desc2', { strong: (chunks) => <strong className="text-foreground font-bold">{chunks}</strong> })}
                    </span>
                  </li>
                  <li className="flex gap-3">
                    <span className="text-primary mt-1.5">•</span>
                    <span>
                      {t.rich('Experience.jobs.nwc10.desc3', { 
                        strong: (chunks) => <strong className="text-foreground font-bold">{chunks}</strong>,
                        link: (chunks) => <a href="https://www.muchacomida.com/" target="_blank" rel="noopener noreferrer" className="text-primary hover:underline font-bold">{chunks}</a>
                      })}
                    </span>
                  </li>
                </ul>
              ...
              <div className="relative pl-8 border-l-2 border-border">
                ...
                <div className="mb-4">
                  <div className="flex flex-col sm:flex-row sm:items-baseline sm:justify-between gap-2 mb-2">
                    <h3 className="text-2xl font-semibold">{t('Experience.jobs.onepingpong.role')}</h3>
                    <span className="text-sm text-muted-foreground">2014 - 2015</span>
                  </div>
                  <p className="text-primary font-medium">{t('Experience.jobs.onepingpong.company')}</p>
                </div>
                ...
                <ul className="space-y-3 text-muted-foreground">
                   <li className="flex gap-3">
                    <span className="text-primary mt-1.5">•</span>
                    <span>
                      {t.rich('Experience.jobs.onepingpong.desc1', { strong: (chunks) => <strong className="text-foreground font-bold">{chunks}</strong> })}
                    </span>
                  </li>
                  <li className="flex gap-3">
                    <span className="text-primary mt-1.5">•</span>
                    <span>
                      {t.rich('Experience.jobs.onepingpong.desc2', { strong: (chunks) => <strong className="text-foreground font-bold">{chunks}</strong> })}
                    </span>
                  </li>
                  <li className="flex gap-3">
                    <span className="text-primary mt-1.5">•</span>
                    <span>
                      {t.rich('Experience.jobs.onepingpong.desc3', { strong: (chunks) => <strong className="text-foreground font-bold">{chunks}</strong> })}
                    </span>
                  </li>
                </ul>
              </div>
        ...
        <section id="education" className="container mx-auto px-4 sm:px-6 lg:px-8 py-16">
          <div className="max-w-7xl">
            <h2 className="text-3xl sm:text-4xl font-bold mb-12">{t('Education.title')}</h2>
              ...
              <Card className="p-6 border-blue-500/30 bg-blue-500/5 hover:border-blue-500/50 transition-colors">
                <div className="flex items-start gap-4">
                  ...
                  <div className="space-y-2">
                    <Badge className="bg-blue-500 hover:bg-blue-600 text-white mb-2">{t('Education.cert_official')}</Badge>
                    <h3 className="text-xl font-bold">{t('Education.cert_title')}</h3>
                    <p className="text-muted-foreground">{t('Education.cert_desc')}</p>
                    <p className="text-sm text-muted-foreground/60">{t('Education.cert_inst')}</p>
                  </div>
                </div>
              </Card>
              ...
              <Card className="p-6 hover:border-foreground/20 transition-colors">
                <div className="flex items-start gap-4">
                  ...
                  <div className="space-y-4">
                    <h3 className="text-xl font-bold">{t('Education.languages_title')}</h3>
                    <div className="space-y-2">
                        <p className="text-muted-foreground">{t('Education.languages_es')}</p>
                        <p className="text-muted-foreground">{t('Education.languages_en')}</p>
                    </div>
        ...
        {/* Contact Section */}
        <section id="contact" className="container mx-auto px-4 sm:px-6 lg:px-8 py-16 pb-32">
