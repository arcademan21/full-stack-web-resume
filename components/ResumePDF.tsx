  ...
  <Document>
    <Page size="A4" style={styles.page}>
        ...
        <View style={styles.headerInfo}>
          ...
          <View style={styles.contactRow}>
            ...
            <Link src={data.contact.linkedin} style={styles.link}>
              linkedin.com/in/haroldyarturo
            </Link>
            <Link src={data.contact.github} style={styles.link}>
              github.com/ARCADEMAN21
            </Link>
          </View>
        </View>
      ...
      <View style={styles.section}>
        ...
        {data.about.p3 ? (
          <Text style={styles.text}>{data.about.p3}</Text>
        ) : null}
      </View>
      ...
      {/* Contact */}
      <View style={styles.section}>
        <Text style={styles.sectionTitle}>{data.contactSection.title}</Text>
        <Text style={styles.text}>{data.contactSection.description}</Text>
        <View style={{ marginTop: 6, gap: 4 }}>
          <Text style={styles.text}>
            <Text style={styles.bold}>{data.contactSection.emailLabel}: </Text>
            <Link src={`mailto:${data.contact.email}`} style={styles.link}>
              {data.contact.email}
            </Link>
          </Text>
          <Text style={styles.text}>
            <Text style={styles.bold}>
              {data.contactSection.linkedinLabel}:{" "}
            </Text>
            <Link src={data.contact.linkedin} style={styles.link}>
